...
### Expected loss 
Finally, we might want to calculate the expected loss by churn, sort from highest to lowest probability of churning, and also gather customer contact info.
